...
def optimalAlphaAdaptive(dataset_path, ID, Color, optimal_rho, holeFilling, areaFiltering, P, connectivity, shadRemov):
    ...
    for alpha in alpha_vec:
        ...
        if shadRemov:
            precision, recall, fscore = clf.performance_measures_shadowRemoval(train_frames_c, test_frames_bw,
                                                                               ...
                                                                               holeFilling, areaFiltering, connectivity,
                                                                               P)
        else:
            precision, recall, fscore = clf.performance_measures(test_frames_bw, test_gts, frame_size,  holeFilling, areaFiltering, connectivity, P)
...
def optimalPAdaptive(dataset_path, ID, Color, optimal_rho, holeFilling, areaFiltering, connectivity):
    ...
    for p in P_vec:
        ...
        for alpha in alpha_vec:
            ...
            precision, recall, fscore = clf.performance_measures(test_frames, test_gts, frame_size,  holeFilling, areaFiltering, p, connectivity)
