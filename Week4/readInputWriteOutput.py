...
def precisionRecallCurveDataset(precision_w3, precision_w4, recall_w3, recall_w4, ID):

    AUC_w3 = auc(recall_w3, precision_w3)
    AUC_w4 = auc(recall_w4, precision_w4)
    ...
    ax3.plot(recall_w4, precision_w4,'b', linewidth=2.0, label='Week 4')
    plt.legend(bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)
    ...
    print '     Area Under Curve (AUC) of Week 4 = ', AUC_w4
